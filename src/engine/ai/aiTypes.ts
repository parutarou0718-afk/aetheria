export type AiPurpose = 'DM_ACTION' | 'NPC_DIALOGUE' | 'WORLD_GENESIS' | 'WORLD_PROFILE' | 'WORLD_SKELETON' | 'WORLD_ENTITY_GENERATION' | 'CAUSALITY' | 'MEMORY_SUMMARY' | 'PROPOSAL_REPAIR' | 'WORLD_AUTHORING';
